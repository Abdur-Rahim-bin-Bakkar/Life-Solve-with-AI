...
import { Mail, Lock, User, ArrowRight, Sparkles, Eye, EyeOff, Camera, Upload } from "lucide-react"
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-4 py-12">
        ...
        >
          ...
          <p className="mt-1 text-sm text-slate-500">Join the community and start your healing journey</p>
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div
                  ...
                  className="group flex h-20 w-20 cursor-pointer items-center justify-center overflow-hidden rounded-full border-2 border-dashed border-slate-300 bg-slate-50 transition-all hover:border-teal-400 hover:bg-teal-50"
                >
                  {imagePreview ? (
                    <img src={imagePreview} alt="Preview" className="h-full w-full object-cover" />
                  ) : (
                    <Camera className="h-7 w-7 text-slate-400 transition-all group-hover:scale-110 group-hover:text-teal-500" />
                  )}
                ...
                <p className="mt-1.5 text-center text-xs text-slate-400">Profile photo (optional)</p>
              </div>
            </div>
