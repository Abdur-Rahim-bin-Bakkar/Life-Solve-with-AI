        ...
        <div className="flex flex-1 flex-col min-w-0">
          <div className="flex items-center gap-3 border-b border-slate-100 bg-white/50 px-4 py-3 backdrop-blur-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="sm:hidden flex h-7 w-7 items-center justify-center rounded-full bg-emerald-50">
                ...
                {messages.map((msg, i) => (
                  ...
                  >
                    ...
                    <div className={`max-w-[90%] sm:max-w-[75%] ${
                      msg.role === "user"
                        ? "rounded-2xl rounded-tr-sm bg-gradient-to-r from-teal-500 to-teal-600 px-3 py-2 sm:px-4 sm:py-2.5 text-sm text-white shadow-sm"
