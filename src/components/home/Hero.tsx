...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const stepTimer = setInterval(() => setStepIndex((p) => (p + 1) % steps.length), 3000)
      ...
      <div className="relative mx-auto flex min-h-[92vh] max-w-7xl flex-col justify-center px-4 py-24 sm:px-6 lg:px-8">
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          >
            ...
            >
              LifeSolve AI is a safe space where you can share life&apos;s challenges anonymously, receive
              instant personalized solutions from our AI, and connect with a community that genuinely
              understands.
            </motion.p>
              ...
              {steps.map((step, i) => (
                ...
                >
                  <motion.span
                    ...
                    transition={{ duration: stepIndex === i ? 3 : 0.3, ease: "linear" }}
                  />
                  <div className={`flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br ${step.gradient} shadow-lg`}>
            ...
            <div className="relative aspect-square">
              ...
              {steps.map((step, i) => {
                ...
                return (
                  ...
                  >
                    <step.icon
                      className={`h-6 w-6 ${stepIndex === i ? "text-amber-300" : "text-white/80"}`}
                    />
                  </motion.div>
                )
              })}
                  ...
                  >
                    ...
                    <div className={`mt-2 rounded-xl bg-gradient-to-br ${showcaseCards[cardIndex].accent} p-3`}>
                      ...
                      <p className="mt-1 text-xs leading-relaxed text-white">
                        {showcaseCards[cardIndex].insight}
                      </p>
                    </div>
                  </motion.div>
                </AnimatePresence>
